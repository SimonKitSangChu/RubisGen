...
parser.add_argument('--fasta', default='data/uniprot/uniref50.fasta', help='Fasta file')
parser.add_argument('--lr', default=2e-4, type=float, help='Learning rate')
parser.add_argument('--causal', action='store_true', help='(experimental) Use causal perceiver model')
